...
def setup():
	...
	myDataPath=("Arduino/Programmes/Ecriture_dans_csv/test1/")
	
	path=homePath()+myDataPath  # chemin du répertoire à utiliser
	filename="testdata.csv" # nom du fichier
	...
	for t in range(1440) : # defile 1440 minutes theoriques
		dataValue=str(random(0,250)) # genere une valeur aleatoire entiere
