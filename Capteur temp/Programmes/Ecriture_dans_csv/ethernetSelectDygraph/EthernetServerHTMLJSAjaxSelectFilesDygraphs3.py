...
def pageInitialeHTMLJS():
	...
	filename=today("-",-1)+".csv" # nom du fichier du jour 
	...
	dirPath=("/media/03BE-8CFD/")+myDataPath 
	print dirPath
...
<html>
    <head>
        ...
        <!--[if IE]><script src="http://127.0.0.1/javascript/dygraphs/excanvas.js"></script><![endif]--->
